...
\section{\huge Podstawy kinematyki}
    ...
    \end{center}
    Na powyższym rysunku zaznaczono też wektory szybkości kątowej $\omega$ i przyspieszenia kątowego $\alpha$. Można
    się spotkać z określeniem, że są to pseudowektory - faktycznie można opisać te wielkości przy pomocy wersorów, np:
